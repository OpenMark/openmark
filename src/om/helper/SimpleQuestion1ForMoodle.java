...
/**
 * Same as main SimpleQuestion1 but with attempts remaining text changed to 'tries remaining'
 * as used in Moodle.
 * 
 * To enable the calculation of statistics for variants authors must include
 * getResults().setQuestionLine("Variant=" + iVariant); 
 */
public abstract class SimpleQuestion1ForMoodle extends StandardQuestion
{
