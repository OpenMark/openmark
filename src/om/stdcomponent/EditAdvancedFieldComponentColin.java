 ...
 * 
 **/
public class EditAdvancedFieldComponentColin extends QComponent implements Labelable {
...
//	private static String TINYMCE="tiny_mce/";
	...
	protected void determineExistingTinyMCEOutput() {
		...
		List<EditAdvancedFieldComponentColin> advs = getQDocument()
			.find(EditAdvancedFieldComponentColin.class);
		if (null != advs ? advs.size() > 0 : false) {
			x : for (EditAdvancedFieldComponentColin adv : advs) {
