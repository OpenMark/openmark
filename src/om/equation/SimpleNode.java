...
public class SimpleNode implements Node {
  ...
  // sam added:  
  private final static Set STANDARDFUNCTIONS=new HashSet(
  ...
  private final static Map STANDARDSYMBOLS;
  ...
  private String sContent=null,sName=null;
  private List lAttributes=new LinkedList();
  public void setContent(String sContent) { this.sContent=sContent; }
  public void setName(String sName) { this.sName=sName; }
  public void setAttribute(String sAttribute,String sName) { lAttributes.add(new String[]{sAttribute,sName}); }
  ...
  public Element createDOM(Document d,boolean bIncludeWhitespace)
  {
  	...
  	for(Iterator i=lAttributes.iterator();i.hasNext();)
  	{
  		String[] as=(String[])i.next();
  	...
  	for(int i=0;i<jjtGetNumChildren();i++)
  	{
			...
			if(STANDARDFUNCTIONS.contains(sChildName))
  		{
			...
			else if(STANDARDSYMBOLS.containsKey(sChildName))
			{
				...
				XML.createText(eChild,(String)STANDARDSYMBOLS.get(sChildName));
			}
