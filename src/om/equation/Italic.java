...
/**
 * Doesn't do anything in itself, but helps to display the child text items in
 * italic style. See Text.java for the actual code.
 */
public class Italic extends Item {
	...
	{
		f.addItemClass("italic",new ItemCreator()
			{	public Item newItem()	 {	return new Italic();	}	});
	}
